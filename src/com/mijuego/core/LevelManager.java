...
import com.mijuego.entities.enemies.SteelSentinel;
...
public class LevelManager {
    ...
    private void initTileset() {
        ...
        tileset[10] = new Tile(Tile.STEELSENTINEL);
    }
        ...
        try {
            ...
            for (int r = 0; r < currentTileMap.getRows(); r++) {
                for (int c = 0; c < currentTileMap.getCols(); c++) {
                    ...
                    else if (tileId == 10) { // Boss 1
                        SteelSentinel SteelSentinel = new SteelSentinel(c * Tile.SIZE, r * Tile.SIZE, currentTileMap, player);
                        enemies.add(SteelSentinel);
                        currentTileMap.setTileId(r, c, 0); // lo borramos del mapa
                    }
                }
            }
